...
|-----------|------|---------|------------|
| WitnessOS site (HTML pages) | Static site | v0.1.0-spec | Yes (published) |
| SPEC.md (public spec) | Specification | v0.1.0-spec | Yes (normative) |
| audit-tool | Shipped scripts | v0.1.0-spec | Yes |
